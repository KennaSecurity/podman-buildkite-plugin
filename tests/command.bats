...
@test "Run with BUILDKITE_COMMAND" {
  ...
  stub podman \
    "run -it --rm --volume $PWD:/workdir --workdir /workdir --env BUILDKITE_JOB_ID --env BUILDKITE_BUILD_ID --env BUILDKITE_AGENT_ACCESS_TOKEN --volume /buildkite-agent:/usr/bin/buildkite-agent --privileged --label com.buildkite.job-id=1-2-3-4 image:tag /bin/sh -e -c 'command1 \"a string\"' : echo ran command in podman"
...
@test "Pull image first before running BUILDKITE_COMMAND with mount-buildkite-agent disabled" {
  ...
  stub podman \
    ...
    "run -it --rm --volume $PWD:/workdir --workdir /workdir --privileged --label com.buildkite.job-id=1-2-3-4 image:tag /bin/sh -e -c 'pwd' : echo ran command in podman"
...
@test "Runs BUILDKITE_COMMAND with volumes" {
  ...
  stub podman \
    "run -it --rm --volume $PWD:/app --volume /var/run/podman.sock:/var/run/podman.sock --workdir /app --privileged --label com.buildkite.job-id=1-2-3-4 image:tag /bin/sh -e -c 'echo hello world; pwd' : echo ran command in podman"
...
@test "Runs BUILDKITE_COMMAND with devices" {
  ...
  stub podman \
    "run -it --rm --volume $PWD:/app --device /dev/bus/usb/001/001 --workdir /app --privileged --label com.buildkite.job-id=1-2-3-4 image:tag /bin/sh -e -c 'echo hello world; pwd' : echo ran command in podman"
...
@test "Runs BUILDKITE_COMMAND with publish" {
  ...
  stub podman \
    "run -it --rm --volume $PWD:/app --workdir /app --publish 80:8080 --publish 90:9090 --privileged --label com.buildkite.job-id=1-2-3-4 image:tag /bin/sh -e -c 'echo hello world; pwd' : echo ran command in podman"
...
@test "Runs BUILDKITE_COMMAND with sysctls" {
  ...
  stub podman \
    "run -it --rm --volume $PWD:/app --sysctl net.ipv4.ip_forward=1 --sysctl net.unix.max_dgram_qlen=200 --workdir /app --privileged --label com.buildkite.job-id=1-2-3-4 image:tag /bin/sh -e -c 'echo hello world; pwd' : echo ran command in podman"
...
@test "Runs BUILDKITE_COMMAND with mount-checkout=false" {
  ...
  stub podman \
    "run -it --rm --privileged --label com.buildkite.job-id=1-2-3-4 image:tag /bin/sh -e -c 'echo hello world; pwd' : echo ran command in podman"
...
@test "Runs BUILDKITE_COMMAND with mount-checkout=true" {
  ...
  stub podman \
    "run -it --rm --volume $PWD:/app --workdir /app --privileged --label com.buildkite.job-id=1-2-3-4 image:tag /bin/sh -e -c 'echo hello world; pwd' : echo ran command in podman"
...
@test "Runs BUILDKITE_COMMAND with environment" {
  ...
  stub podman \
    "run -it --rm --volume $PWD:/workdir --workdir /workdir --env MY_TAG=value --env ANOTHER_TAG=llamas --privileged --label com.buildkite.job-id=1-2-3-4 image:tag /bin/sh -e -c 'echo hello world' : echo ran command in podman"
...
@test "Runs BUILDKITE_COMMAND with shm size" {
  ...
  stub podman \
    "run -it --rm --volume $PWD:/workdir --workdir /workdir --privileged --shm-size 100mb --label com.buildkite.job-id=1-2-3-4 image:tag /bin/sh -e -c 'echo hello world' : echo ran command in podman"
...
EOF
  ...
  stub podman \
    "run -it --rm --volume $PWD:/workdir --workdir /workdir --env MY_TAG=value --privileged --env FOO --env A_VARIABLE --label com.buildkite.job-id=1-2-3-4 image:tag /bin/sh -e -c 'echo hello world' : echo ran command in podman"
...
@test "Runs BUILDKITE_COMMAND with user" {
  ...
  stub podman \
    "run -it --rm --volume $PWD:/workdir --workdir /workdir -u foo --privileged --label com.buildkite.job-id=1-2-3-4 image:tag /bin/sh -e -c 'echo hello world' : echo ran command in podman"
...
@test "Runs BUILDKITE_COMMAND with userns" {
  ...
  stub podman \
    "run -it --rm --volume $PWD:/workdir --workdir /workdir --userns foo --privileged --label com.buildkite.job-id=1-2-3-4 image:tag /bin/sh -e -c 'echo hello world' : echo ran command in podman"
...
@test "Runs BUILDKITE_COMMAND with additional groups" {
  ...
  stub podman \
    "run -it --rm --volume $PWD:/workdir --workdir /workdir --group-add foo --group-add bar --privileged --label com.buildkite.job-id=1-2-3-4 image:tag /bin/sh -e -c 'echo hello world' : echo ran command in podman"
...
@test "Runs BUILDKITE_COMMAND with propagated uid and guid" {
  ...
  stub podman \
    "run -it --rm --volume $PWD:/workdir --workdir /workdir -u 123:456 --privileged --label com.buildkite.job-id=1-2-3-4 image:tag /bin/sh -e -c 'echo hello world' : echo ran command in podman"
...
@test "Runs BUILDKITE_COMMAND with network that doesn't exist" {
  ...
  stub podman \
    ...
    "run -it --rm --volume $PWD:/workdir --workdir /workdir --privileged --network foo --label com.buildkite.job-id=1-2-3-4 image:tag /bin/sh -e -c 'echo hello world' : echo ran command in podman"
...
@test "Runs BUILDKITE_COMMAND with custom runtime" {
  ...
  stub podman \
    "run -it --rm --volume $PWD:/workdir --workdir /workdir --privileged --runtime custom_runtime --label com.buildkite.job-id=1-2-3-4 image:tag /bin/sh -e -c 'echo hello world' : echo ran command in podman"
...
@test "Runs BUILDKITE_COMMAND with custom IPC option" {
  ...
  stub podman \
    "run -it --rm --volume $PWD:/workdir --workdir /workdir --privileged --ipc host --label com.buildkite.job-id=1-2-3-4 image:tag /bin/sh -e -c 'echo hello world' : echo ran command in podman"
...
@test "Runs BUILDKITE_COMMAND with entrypoint without explicit shell" {
  ...
  stub podman \
    "run -it --rm --volume $PWD:/workdir --workdir /workdir --privileged --entrypoint /some/custom/entry/point --label com.buildkite.job-id=1-2-3-4 image:tag 'echo hello world' : echo ran command in podman"
...
@test "Runs BUILDKITE_COMMAND with entrypoint with explicit shell" {
  ...
  stub podman \
    "run -it --rm --volume $PWD:/workdir --workdir /workdir --privileged --entrypoint /some/custom/entry/point --label com.buildkite.job-id=1-2-3-4 image:tag custom-bash -a -b 'echo hello world' : echo ran command in podman"
...
@test "Runs BUILDKITE_COMMAND with entrypoint disabled by null" {
  ...
  stub podman \
    "run -it --rm --volume $PWD:/workdir --workdir /workdir --entrypoint '\'\'' image:tag 'echo hello world' : echo ran command in podman"
...
@test "Runs BUILDKITE_COMMAND with shell" {
  ...
  stub podman \
    "run -it --rm --volume $PWD:/workdir --workdir /workdir --privileged --label com.buildkite.job-id=1-2-3-4 image:tag custom-bash -a -b 'echo hello world' : echo ran command in podman"
...
@test "Runs BUILDKITE_COMMAND with shell option as string" {
  ...
  assert_failure
  assert_output --partial "shell configuration option cannot be specified as a string, but only as an array"
}
...
@test "Runs BUILDKITE_COMMAND with shell disabled" {
  ...
  stub podman \
    "run -it --rm --volume $PWD:/workdir --workdir /workdir --privileged --label com.buildkite.job-id=1-2-3-4 image:tag 'echo hello world' : echo ran command in podman"
...
@test "Runs BUILDKITE_COMMAND with add-host" {
  ...
  stub podman \
    "run -it --rm --volume $PWD:/workdir --workdir /workdir --add-host buildkite.fake:127.0.0.1 --add-host www.buildkite.local:0.0.0.0 --privileged --label com.buildkite.job-id=1-2-3-4 image:tag /bin/sh -e -c 'echo hello world' : echo ran command in podman"
...
@test "Runs with a command as an array with a shell and an entrypoint" {
  ...
  stub podman \
    "run -it --rm --volume $PWD:/workdir --workdir /workdir --privileged --entrypoint llamas.sh --label com.buildkite.job-id=1-2-3-4 image:tag custom-bash -a -b echo 'hello world' : echo ran command in podman"
...
@test "Doesn't disclose environment" {
  ...
  stub podman \
    "run -it --rm --volume $PWD:/workdir --workdir /workdir --privileged --label com.buildkite.job-id=1-2-3-4 image:tag /bin/sh -e -c 'echo hello world' : echo ran command in podman"
